...
function LandingPage3 () {
    ...
    return <>
    <Container minW="100%" bgColor="#FFF" mb="30px">
       <Box ml="-18px" mr="-18px" borderBottom="1px solid gray"><Heading as="h3" pl="18px" fontSize={"15px"} color="#333333"
        ...
        <Box mt="20px" pl="32px" _hover={{cursor:"pointer"}}>
        ...
        <HStack mt="10px" ml="6px" _hover={{cursor:"pointer"}}>
            <HStack mr="50px">
        ...
        <HStack mt="5px" ml="6px" _hover={{cursor:"pointer"}}>
            ...
            <HStack mt="5px" ml="2px" _hover={{cursor:"pointer"}}>
