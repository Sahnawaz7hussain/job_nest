...
import { VStack,Flex,Box,Image,Button,Stack,Menu,
    MenuButton,
    MenuList,
    MenuItem,
    Spacer,Grid, GridItem } from "@chakra-ui/react";
        ...
        <VStack display={{ lg: 'flex' }}>
            <Flex w={{ base: '100%', sm: '50%', md: '100%' }} h={"8rem"}>
                ...
                <Menu isLazy={{md:"show"}}>
                    ...
                    <MenuList backgroundColor={"white"} color={"black"}  minH="15em" minW="50em" >
                    ...
                    <MenuList backgroundColor={"white"} color={"black"}  minH="15em" minW="50em" >
                        {/* MenuItems are not rendered unless Menu is open */}
                        <MenuItem  >
                                <Grid templateColumns='repeat(5, 1fr)' gap={6} w="200%" ml="5%" >
                                    
                                    <Grid templateColumns='repeat(1, 1fr)' gap={6} w="200%" ml="5%">
                                    <GridItem >
                                    <b>Resume writing</b>
                                    <br/>
