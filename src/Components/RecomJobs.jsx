...
function RecommendedJobs1 () {
    ...
    {jobsData.length>0 && jobsData.map((elem) => (
        ...
        <Container minW="100%" border={"1px solid purple"} key={elem.id} onClick={() => handleClick (elem.id)} _hover={hoverEffect}>
...
export default RecommendedJobs1



{/* <Container minW="100%" border={"1px solid purple"}>
...
<HStack mt="10px" ml="6px">
    ...
    <HStack pr="50px" border={"1px solid red"}>
        <Box w="18px"><Image src={wallet} alt="Portfolio" /></Box>
        <Box><Text fontSize={"13px"} color="#666666"> {elem.package}</Text></Box>
    </HStack>
    ...
    <HStack mt="5px" ml="2px" pl="2px">
        <Box w="20px"><Image src="https://i.ibb.co/8sN2CY5/paper.png" alt="summary" /></Box>
        <Box><Text fontSize={"13px"} color="#666666">{elem.summary}</Text></Box>
    </HStack>  

    <HStack mt="5px" ml="6px" pl="2px">
        <Box><Text fontSize={"13px"} color="#666666">{elem.skills}</Text></Box>
    </HStack>
