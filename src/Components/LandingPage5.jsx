...
function LandingPage5 () {
    ...
    <Container minW="100%" border={"1px solid red"} mb="10px">
    ...
    <Center><Box width="52%" mt="20px" mb="20px" border={"1px solid red"}><Text p="0px 18px" lineHeight="16px" textAlign="center" fontSize="13px">You do not have any unread message. Messages received from different recruiters will appear in this section.</Text></Box></Center> 
    </Container>


    <Container minW="100%" border={"1px solid red"}>
    <Box ml="-18px" mr="-18px" borderBottom="1px solid gray" mb="14px"><Heading pl="18px" as="h3" fontSize={"15px"} color="#333333"
        ...
        <HStack minW="100%" alignItems="start">
            ...
            <VStack border={"1px solid red"} minW="25%" h="175px" mr="8.5%" pl="8px" alignItems="start">
            ...
            <VStack border={"1px solid red"} minW="65%" h="175px" alignItems="start">
                ...
                <Box pt="18px"><Button fontSize="14.5px" color="#FFF" bgColor="#4A90E2" borderRadius="none" p="0px 32px">BUY CREDITS</Button></Box>
